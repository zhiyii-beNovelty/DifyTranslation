...
あくまでテスト目的です。後で削除してください。AIエージェントは素晴らしいです！

FabriXAIのAIエージェントは、ワークフローの自動化と特定のユースケースの強化を目的として設計されています。FabriXAIを使用すると、タスクのニーズに応じて、AIエージェントを2つの形式で展開できます：

- **ウェブアプリ**: ブラウザ経由でアクセス可能な独立型アプリケーションを必要とするタスク、例えばフォーム送信やドキュメント生成に最適です。
- **チャットボット**: カスタマーサポートやバーチャルアシスタントのようなリアルタイムの会話インタラクションに最適です。

このガイドでは、カスタマイズされたAIエージェントを作成および構成するために必要なステップとコンポーネントを順を追って説明します。
